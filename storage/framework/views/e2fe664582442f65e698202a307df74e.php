...
<body>
    ...
    <aside class="w-64 flex-shrink-0 flex flex-col justify-between fixed top-0 left-0 h-full "
        ...
        <div class="flex flex-col flex-1">
            ...
            <nav class="p-4 space-y-2 text-sm overflow-y-auto flex-1">
                <a href="<?php echo e(route('customer.produk')); ?>" class="sidebar-link" data-path="/customer/produks">
                    <i class="fa-solid fa-box"></i><span>Product</span>
                </a>
                <a href="<?php echo e(route('cart-customer.index')); ?>" class="sidebar-link" data-path="/cart-customer">
                    <i class="fa-solid fa-cart-shopping"></i><span>Cart</span>
                </a>
                <a href="<?php echo e(route('order-customer')); ?>" class="sidebar-link" data-path="/order-customer">
                    <i class="fa-solid fa-list-ul"></i><span>My Orders</span>
                </a>
                <a href="<?php echo e(route('notif-customer')); ?>" class="sidebar-link" data-path="/notif-customer">
                    <i class="fa-solid fa-bell"></i><span>Notification</span>
                    <?php if($unreadNotificationsCount > 0): ?>
                        <span class="ml-auto bg-[#ff483bff] text-white text-xs px-2 py-0.5 rounded-full"><?php echo e($unreadNotificationsCount); ?></span>
                    <?php endif; ?>
                </a>
                <a href="<?php echo e(route('chat-customer')); ?>" class="sidebar-link" data-path="/chat-customer">
                ...
                <a href="<?php echo e(route('softpay-customer')); ?>" class="sidebar-link" data-path="/softpay">
                    <i class="fa-solid fa-wallet"></i><span>SoftPay</span>
                </a>
                <a href="<?php echo e(route('bantuan-customer')); ?>" class="sidebar-link" data-path="/bantuan-customer">
        ...
        <div class="p-4 space-y-2 flex-shrink-0">
            <div class="p-4 py-5">
                <a href="<?php echo e(route('setting-customer')); ?>" class="user-profile-link" data-path="/setting-customer">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 rounded-full overflow-hidden">
                            ...
                            : asset('img/man.jpg');
                            ?>
                            <img src="<?php echo e(Auth::user()->profile_picture_url); ?>" alt="User Profile" class="w-full h-full object-cover">
                        </div>
                        <div>
                            <div class="font-medium"><?php echo e(Auth::user()->name ?? 'Guest'); ?></div>
                            <div class="text-sm text-gray-400">Account settings</div>
                        </div>
                    </div>
                </a>
            </div>
            <a href="<?php echo e(route('setting-customer')); ?>" class="sidebar-footer-link" data-path="/setting-customer">
    ...
    <div class="flex-1 overflow-y-auto"> <?php echo $__env->yieldContent('isi'); ?>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateChatUnreadCount() {
                fetch('<?php echo e(route('api.chat.unreadCount')); ?>', {
                    method: 'GET',
                    headers: {
...
</html><?php /**PATH E:\Aplikasi\laragon\www\softably\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>