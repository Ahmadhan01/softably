...
<body class="text-gray-800">
    <header class="bg-white py-4 px-8 flex justify-between items-center shadow-sm fixed top-0 left-0 w-full z-50">
        ...
        <div class="flex items-center space-x-4">
            <a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-blue-600 font-medium">Masuk</a>
    ...
    <section class="dark-section text-white px-8 lg:px-16 flex flex-col md:flex-row items-center justify-center gap-20">
        ...
        <div class="relative w-full md:w-1/2 flex justify-center items-center h-[400px] md:h-[500px]">
            ...
            <?php $__currentLoopData = $bestSellingProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div id="product-card-<?php echo e($loop->iteration); ?>" class="product-card">
                    <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" class="w-3/4 h-3/4 object-cover rounded-md">
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const productsData = <?php echo json_encode($bestSellingProducts->map(function($product) {
                return [
                    'name' => $product->name, 'sold' => $product->sales_count . ' Terjual', // Format sesuai kebutuhan
...
</html><?php /**PATH E:\Aplikasi\laragon\www\softably\resources\views/landing-page.blade.php ENDPATH**/ ?>