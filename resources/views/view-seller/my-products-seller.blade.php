        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="bg-[#1e293b] rounded-lg shadow-md p-4 flex flex-col"> {{-- Tambahkan flex flex-col --}}
                ...
                <a href="{{ route('seller.products.details', $product->id) }}"
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-medium text-center transition-colors">
                    Check Details
                </a>
            </div>
            @empty
            <div class="col-span-full text-center text-gray-400 py-10">
                <p>Anda belum memiliki produk. Mari tambahkan yang pertama!</p>
