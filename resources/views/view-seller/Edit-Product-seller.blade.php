    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col px-8 py-8">
            <div class="flex items-center mb-8 gap-4">
                <a href="/Details-Product-seller" class="text-white hover:text-gray-300"><i
                ...
                <div class="space-y-8">
                    <div class="bg-[#29314a] rounded-lg p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" value="Template Canva"
                    ...
                    <div class="bg-[#29314a] rounded-lg p-6">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">Public</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" checked>
                                <div
                        ...
                        <div class="mb-4">
                            ...
                            <textarea rows="3"
                                class="w-full bg-[#23293a] border border-gray-600 text-white px-4 py-2 rounded-lg focus:outline-none">Lorem ipsum dolor sit amet consectetur. A erat quam sed tempus nulla. Consequat sem egestas et vel laoreet tempus eros.</textarea>
                        </div>
                    </div>
                </div>
            </form>
            <div class="flex flex-col md:flex-row justify-end gap-4 mt-8">
                ...
                <a href="/Details-Product-seller">
                    <button class="bg-green-500 text-white px-8 py-3 rounded-lg font-semibold">Edit</button>
            </div>
        </div>
    </div>
</body>
