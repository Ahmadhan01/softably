        ...
        <main class="flex-1 p-6 space-y-6 ml-64">
            ...
            <div class="flex bg-[#111C2E] rounded-md overflow-hidden">
                <div class="w-1/4 border-r border-gray-700 p-6 space-y-6">
                    ...
                    <div><a href="/setting-seller" class="text-white font-medium">Account</a></div>
                            ...
                            <div class="w-10 h-10 rounded-full overflow-hidden bg-white">
                                @php
                                    ...
                                    $imageUrl = $profilePicture
                                        ? asset('storage/profile/' . $profilePicture)
                                        : asset('img/man.jpg');
                                @endphp

                                <img src="{{ asset($user->profile_picture) }}" alt="Foto Profil" width="100">
