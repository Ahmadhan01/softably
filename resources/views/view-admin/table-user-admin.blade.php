            ...
            <div id="modal-{{ $user->id }}"
                ...
                <div
                    ...
                    <div class="flex justify-center mb-4">
                        <img src="{{ $user->profile_picture ? url('profile/' . $user->profile_picture) . '?t=' . time() : asset('img/man.jpg') }}"
                            alt="Avatar" class="w-24 h-24 rounded-full object-cover border-2 border-blue-500 shadow-lg">
                    </div>
