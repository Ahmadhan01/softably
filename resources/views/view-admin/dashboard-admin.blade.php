        ...
        <aside class="w-64 bg-[#1e293b] flex flex-col justify-between fixed top-0 left-0 h-full">
            <div>
                ...
                <nav class="p-4 space-y-2 text-sm text-gray-300">
                    ...
                    <a href="/produk" class="flex items-center space-x-2 hover:bg-white/10 px-3 py-2 rounded">
                        <span>🛒</span><span>Product</span>
                    </a>
                    <a href="/chart" class="flex items-center space-x-2 hover:bg-white/10 px-3 py-2 rounded">
                        <span>📊</span><span>Charts</span>
                    </a>
                    <a href="/table_user" class="flex items-center space-x-2 hover:bg-white/10 px-3 py-2 rounded">
                        <span>👤</span><span>Table User</span>
                    </a>
                    <a href="/notif" class="flex items-center space-x-2 hover:bg-white/10 px-3 py-2 rounded">
                        <span>🔔</span><span>Notification</span>
                        <span class="ml-auto bg-green-500 text-white text-xs px-2 py-0.5 rounded-full">4</span>
                    </a>
                    <a href="/faq" class="flex items-center space-x-2 hover:bg-white/10 px-3 py-2 rounded">
            ...
            <div class="p-4 space-y-2">
                <a href="/setting" class="flex items-center space-x-2 text-gray-400 hover:text-white">
                    <span>⚙️</span><span>Settings</span>
                </a>
                <a href="/login" class="flex items-center space-x-2 text-gray-400 hover:text-white">
