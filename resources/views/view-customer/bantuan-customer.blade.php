...
<main class="ml-64 min-h-screen flex flex-col bg-[#10172A] text-white">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- PERBAIKAN DI SINI: Tambahkan event listener untuk setiap tautan topik ---
            topicLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    e.preventDefault(); // Mencegah perilaku default tautan (gulir ke #)
                    const targetId = this.dataset.target; // Ambil nilai data-target dari tautan yang diklik
            ...
            function sendMessageToAdmin() {
                ...
                fetch('/chat/admin/send', {
                        method: 'POST',
                        credentials: 'same-origin', // <- WAJIB supaya session login ikut dikirim
                        headers: {
            ...
            // Opsional: Aktifkan tab "Home" secara default saat halaman dimuat
