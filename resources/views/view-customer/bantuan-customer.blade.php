      ...
      >
        <div>
          ...
          <nav class="p-4 space-y-2 text-sm text-gray-300">
            ...
            <a
              href="/faq_customer"
              class="flex items-center space-x-2 bg-white/10 text-white 10 px-3 py-2 rounded"
            >
        ...
        <div class="w-full md:w-1/4 xl:w-2/6 border-r border-gray-700 p-4">
          ...
          <ul class="space-y-3 overflow-y-auto max-h-[calc(100vh-200px)] pr-2">
              <div class="fle x-1">
                ...
                <a href=""
                  class="text-white text-gray-400 hover:text-white">
                  <span>- Toko Ahmad</span>
                </a>
              </div>
            </li>
            <li
