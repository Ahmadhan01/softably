       ...
       <aside class="w-64 bg-[#1e293b] flex flex-col justify-between fixed top-0 left-0 h-full">
            <div>
                ...
                <nav class="p-4 space-y-2 text-sm text-gray-300">
                    ...
                    <a href="/cart_customer" class="flex items-center space-x-2 bg-white/10 text-white px-3 py-2 rounded">
                    ...
                    <a href="/aq_customer" class="flex items-center space-x-2 hover:bg-white/10 px-3 py-2 rounded">
