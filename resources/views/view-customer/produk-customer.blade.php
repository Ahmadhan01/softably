...
@section('isi')
    ...
    <main class="flex-1 p-6 space-y-6 ml-64 bg-[#F8FAFC] text-[#333333] min-h-screen"> {{-- Lapisan latar belakang putih yang sticky --}}
        <div
            ...
            <form action="{{ route('customer.produk') }}" method="GET" class="relative max-w-md w-full">
                <input type="text" id="simple-search" name="search"class="bg-[#2563EB] border border-[#2563EB] text-white text-sm rounded-lg focus:ring-0 focus:border-transparent focus:outline-none block w-full pl-10 pr-4 py-2.5 h-10 placeholder-white" placeholder="Search product..." value="{{ request('search') }}" />
            ...
            <div class="flex gap-4 items-center mr-2">
                <a href="{{ route('wishlist-customer.index') }}" class="text-white text-lg hover:text-gray-300"> <i class="fa-solid fa-bookmark"></i>
                </a>
                <a href="{{ route('cart-customer.index') }}" class="text-white text-lg hover:text-gray-300"> <i class="fa-solid fa-cart-shopping"></i>
                </a>
            </div>
        </div>
                ...
                <div class="flex gap-4 sm:gap-6 flex-wrap">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select id="price-filter" name="price_range"
                            ...
                            <option value="all" {{ request('price_range') == 'all' ? 'selected' : '' }}>Semua Harga
                            </option>
        ...
        <div id="product-list-container" class="grid grid-cols-5 gap-4 mt-6">
            @forelse ($products as $product)
                <div class="product-card bg-white p-4 rounded-lg shadow-md" data-product-id="{{ $product->id }}">
                    ...
                    {{ Auth::check() && Auth::user()->hasInWishlist($product->id) ? 'bg-[#2563EB]' : 'bg-gray-300 hover:bg-[#2563EB]' }}"
